import{_ as s,c as n,o as a,V as l}from"./chunks/framework.be58fd72.js";const i=JSON.parse('{"title":"Command List","description":"","frontmatter":{"title":"Command List","order":90000},"headers":[],"relativePath":"tutorials/free/setup/command-list.md","lastUpdated":1685086559000}'),p={name:"tutorials/free/setup/command-list.md"},o=l(`<h1 id="command-list" tabindex="-1">Command List <a class="header-anchor" href="#command-list" aria-label="Permalink to &quot;Command List&quot;">​</a></h1><p>Generated April 17, 2023</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">activateExtra [id]</span></span>
